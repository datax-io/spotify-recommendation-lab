...
class MNISTLoader {
    ...
    static func loadAsTensors(setType: DataSetType) throws -> [[TorchTensor]] {
    ...
    static func load(setType: DataSetType, batchSize: Int) throws -> (data: LazyChunkSequence<[[Float]]>, labels: LazyChunkSequence<[Int]>) {
